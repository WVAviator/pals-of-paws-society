...
export const meta = {
	title: "Volunteer",
	description:
		"Pals of Paws Society welcomes volunteers to assist in fundraising events, help with animal adoptions, provide temporary housing for animals, and help with stray animal population management.",
};
