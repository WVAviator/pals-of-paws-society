...
export const meta = {
	title: "About Us",
	description:
		"Pals of Paws Society is an organization dedicated to reducing pet overpopulation in Northwest Mississippi through adoption assistance, veterinary financial support, implementation of trap-neuter-release (TNR) programs, and arranging animal transportation to areas where adoption demand is higher.",
};
...
Pals of Paws Society is a non-profit organization dedicated to reducing the pet overpopulation problem in Northwest Mississippi. We accomplish this mission by [increasing adoption visibility](/about/adoption) for animal rescue and shelter organizations, by [arranging transportation](/about/transports) for animals into areas of higher adoption demand, through [community outreach and education](/fundraisers), by providing [financial assistance for veterinary care](/about/spayneuter), and through coordination with local, national, and international [animal rescue groups](/partners).
...
- [Spay and Neuter Assistance](/about/spayneuter)
